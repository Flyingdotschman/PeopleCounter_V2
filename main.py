...
def update_the_screen():
    ...
    if not max_people_reached():
        ...
        my_text1 = 'Personen'
        mainCanvas.create_text(480, 950, anchor=NW, text=my_text1, fill='white', font='ITCAvantGardeStd-Demi 80 bold',
                               state='normal')
        my_text3 = str(max_people_allowed)
        mainCanvas.create_text(300, 950, anchor=NW, text=my_text3, fill='white', font='ITCAvantGardeStd-Demi 80 bold',
                               state='normal')
        my_text3 = str(people_inside) + "/"
        mainCanvas.create_text(300, 950, anchor=NE, text=my_text3, fill='white', font='ITCAvantGardeStd-Demi 80 bold',
                               state='normal')
        try:
